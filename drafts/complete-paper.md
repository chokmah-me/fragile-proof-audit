...
- **Live literature (12 gates: 8 BREAK / 4 PASS).** Claims from the
  ...
  Tang--Zhang, Chung--Graham--Spiro (2020), Sárközy's Conjecture 65,
  ...
  Chung--Graham--Spiro, Tang for Sárközy, Giraudin for Thakur, Münch
...
lemma. The dossier's paraphrase had Sárközy's threshold as $|A| \ge cp$;
...
Chung--Graham--Spiro, Sárközy, Thakur, Salez--Youssef, Cohen); where a
...
Legendre--Newman, Erdős--Straus Theorem 10). Three live claims survived
their gates outright -- Lopez's Erdős--Straus system, the Lau--Ono and
