...
**Erratum (2026-09-23):** earlier entries call the lock the "BREAK lock". It is a *verdict* lock: `EXPECTED_VERDICT` pins both verdicts — currently 24 gates, 17 BREAK / 7 PASS. The label is corrected in place throughout; dated counts (21/21, 23/23, …) are left as recorded at the time.
