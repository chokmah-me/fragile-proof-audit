...
Cross-check: the author's frozen `references/mf24-counterexample/check_exact.py` (exact continuant recurrence, direct matrix-power evaluation of p_m, residue blocks from direct weight products, rational LDL positivity) was run independently — EXIT 0 (see blueprint).
