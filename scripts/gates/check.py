...
NLA_IE16 = ROOT / "scripts" / "gates" / "nla_ie16.py"
...
QTSPP_DIAGONAL = ROOT / "scripts" / "gates" / "qtspp_diagonal.py"
...
EXPECTED_VERDICT: dict[str, tuple[str, str]] = {
    ...
    "nla_ie16": ("nla_ie16_gate_meta.json", "PASS"),
...
def run_nla_ie16() -> dict:
    return run_script("nla_ie16", NLA_IE16)


def run_nla_mf14() -> dict:
    return run_script("nla_mf14", NLA_MF14)


def run_nla_mf24() -> dict:
    return run_script("nla_mf24", NLA_MF24)


def run_nla_mi32() -> dict:
...
def run_qtspp_diagonal() -> dict:
    return run_script("qtspp_diagonal", QTSPP_DIAGONAL)
...
GATES: list[tuple[str, object]] = [
    ...
    ("qtspp_diagonal", run_qtspp_diagonal),
]
