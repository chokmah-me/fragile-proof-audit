...
| `Fragile-Route_Harvest_Dossier.md` | Downloads harvest, 2026-09-22 | **Lead.** Number-theory hits. Test-fires are not verdicts. |
| `Fragile-Route_Harvest_Dossier_II.md` | Downloads harvest, 2026-09-22 | **Lead.** Combinatorics/analysis hits. COL-FP closed VACUOUS (Kawasaki v2 does not claim the contraction the test-fire broke). |
